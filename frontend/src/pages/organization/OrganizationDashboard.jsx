...
function OrganizationDashboard() {
  ...
  const fetchStatusCounts = async () => {
    try {
      const res = await fetch(`http://localhost:8000/api/incident_reports/organization/${orgId}/count-by-status`);
  ...
  const fetchViolationCounts = async () => {
    try {
      const res = await fetch(`http://localhost:8000/api/incident_reports/organization/${orgId}/violation-types`);
  ...
  const fetchLocationCounts = async () => {
    try {
      const res = await fetch(`http://localhost:8000/api/incident_reports/organization/${orgId}/locations`);
